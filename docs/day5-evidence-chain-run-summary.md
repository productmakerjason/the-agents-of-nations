...
## 9. Open question for agent/eval/browser-agent builders
...
```txt
Do not build a trust layer alone before validating that other agent/eval/browser-agent builders care about the missing proof layer.
```
